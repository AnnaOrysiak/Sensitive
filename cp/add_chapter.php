...
<head>
<meta charset="utf-8" />
<title>Sensitive opowiadania - dodawanie nowego rozdziału</title>
...
$question="INSERT INTO opowiadania (storyId, chapterNumber, chapterTitle, chapterContents) VALUES ('".$storyId."', '".$chapterNumber."', '".$chapterTitle."', '".$contents."')";
...
if($result) {
	...
	echo "Bingo!<br/><br/>";
	echo "Nowy rozdział został dodany. Oto efekt Twojej pracy. <a href='../indexpanel.php'>Wróć</a> do panelu autora.<br/><p><br/></p>";
