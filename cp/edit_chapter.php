...
<html>
 ...
 <body onload="load();">
     <?php echo rawurldecode($_POST['storyTitle'])." - edycja"; ?>
     <br /><br />
        <form action="cp/update_project.php" method="POST" id="editor">
		...
		<input type="hidden" name="chapterNumber" value="<?php echo $_POST['chapterNumber'];?>" />
                <input type="text" name="chapterTitle" placeholder="Tytuł" onfocus="this.placeholder=' '" onblur="this.placeholder='Tytuł'" value="<?php echo rawurldecode($_POST['chapterTitle']); ?>" /><br />
                <textarea name="text"> <?php include "cp/load_content.php"; ?> </textarea>
