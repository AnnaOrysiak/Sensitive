<html>
    ...
    <body onload="load();">
        <form action="cp/add_news.php" method="POST" id="editor">
		<input type="text" name="title" id="title" placeholder="Tytuł" onfocus="this.placeholder=''" onblur="this.placeholder='Tytuł'" /><br />
